...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_split_3x5_3(
    ...
    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,       KC_N,       KC_M,                   KC_COMM,        KC_DOT,         KC_SLSH,
                                    LT(3, KC_DEL),         LT(1, KC_BSPC),        LT(2, KC_TAB),     LT(5, KC_ENT),     LT(4, KC_SPC),          LT(6, KC_ESC)
  ),
  // NAV
  [1] = LAYOUT_split_3x5_3(
    RESET,   KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_AGIN,   KC_PSTE,   KC_COPY,   KC_CUT,   KC_UNDO,
  ...
  [2] = LAYOUT_split_3x5_3(
    KC_NO,  KC_NO,   KC_UP,     KC_NO,    KC_NO,    KC_AGIN,   KC_PSTE,   KC_COPY,   KC_CUT,   KC_UNDO,
    KC_NO,  KC_LEFT, KC_DOWN,   KC_RIGHT, KC_NO,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_CAPS,
    KC_NO,  KC_ALGR, KC_NO,     KC_NO,    KC_NO,    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_INS,
                      KC_NO,    KC_NO,    KC_NO,    KC_ENT,  KC_BSPC, KC_DEL
  ),
  // MEDIA
  ...
  [4] = LAYOUT_split_3x5_3(
    ...
    KC_QUOT,        KC_4,           KC_5,           KC_6,           KC_EQL,     KC_NO,       KC_LSFT,         KC_LCTL,         KC_RALT,        KC_LGUI,
...
void oled_render_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case L_NAV:
            ...
            break;
        case L_ARROWS:
            oled_write_ln_P(PSTR("Arrows\n"), false);
            break;
        case L_MEDIA:
            oled_write_ln_P(PSTR("Media\n"), false);
            break;
        case L_NUM:
            oled_write_ln_P(PSTR("Numbers\n"), false);
            break;
        case L_SYM:
